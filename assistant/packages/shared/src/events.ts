...
export const streamEventSchema = z.discriminatedUnion('type', [
  ...
  z.object({ type: z.literal('tool.started'), tool: z.string(), callId: z.string(), detail: z.string().optional() }),
  z.object({ type: z.literal('tool.completed'), tool: z.string(), callId: z.string(), summary: z.string().optional() }),
