...
export function ChatFollowUpComposer({ isLoading = false, onSubmit, onStop }: ChatFollowUpComposerProps) {
        ...
        <div className="absolute right-3 flex items-center">
          {isLoading && onStop ? (
            <button
              ...
              onClick={onStop}
              aria-label="Stop"
              className="w-10 h-10 flex items-center justify-center rounded-lg bg-primary-container text-on-primary-container hover:opacity-90 active:scale-95 transition-all shadow-md"
            >
              <span
