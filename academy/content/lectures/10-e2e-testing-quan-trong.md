...
E2E test = chạy qua đường đi gần giống người dùng thật:
- Browser thật (Playwright, Cypress)
- Database test thật hoặc service test container, hạn chế mock ở boundary quan trọng
- HTTP call thật qua network stack
- File I/O thật

Agent khó "mock" được reality hơn. E2E vẫn cần test data sạch và environment ổn định.
...
## Pattern: E2E là verify gate khi chạm behavior người dùng
...
Bước 4 fail = chưa done, dù 1-3 pass. Với thay đổi thuần logic nhỏ, unit/integration có thể đủ; với UI/API/user journey, cần smoke hoặc E2E.
...
→ Agent click qua browser thật thay vì chỉ đọc code. Catch bug integration tốt hơn.
